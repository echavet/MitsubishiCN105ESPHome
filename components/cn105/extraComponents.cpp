...
void CN105Climate::set_vertical_vane_select(
    ...
    // builds option list from SwiCago vaneMap - using const char* for flash storage
    this->vertical_vane_select_->traits.set_options({VANE_MAP[0], VANE_MAP[1], VANE_MAP[2], VANE_MAP[3], VANE_MAP[4], VANE_MAP[5], VANE_MAP[6]});
...
void CN105Climate::set_horizontal_vane_select(
    ...
    // builds option list from SwiCago wideVaneMap - using const char* for flash storage
    this->horizontal_vane_select_->traits.set_options({WIDEVANE_MAP[0], WIDEVANE_MAP[1], WIDEVANE_MAP[2], WIDEVANE_MAP[3], WIDEVANE_MAP[4], WIDEVANE_MAP[5], WIDEVANE_MAP[6], WIDEVANE_MAP[7]});
...
void CN105Climate::set_airflow_control_select(
    ...
    // using const char* for flash storage
    this->airflow_control_select_->traits.set_options({AIRFLOW_CONTROL_MAP[0], AIRFLOW_CONTROL_MAP[1], AIRFLOW_CONTROL_MAP[2]});
